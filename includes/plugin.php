...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \Antifragile_Addon\Plugin The single instance of the class.
	 */
	 ...
	 * @access public
	 * @static
	 * @return \Antifragile_Addon\Plugin An instance of the class.
	 */
	...
	public function custom_categories( $elements_manager ) {
		...
		$elements_manager->add_category(
			'antifragile',
			[
				'title' => esc_html__( 'Antifragile', 'honestdental-addon' ),
				'icon' => 'fa fa-plug',
			]
		);
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/antifragile-blog.php' );

		$widgets_manager->register( new \Antifragile_Addon\Antifragile_Blog() );
